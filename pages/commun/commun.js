...
Page({
  ...
  data: {
    comlistnum: null,
    comlist: [
      { pub_user: '用户名称', pub_user_img: '', communityDescription: '这是分享内容', publishTime: '2020.12.17' },
      { username: '用户名称', userhead: '', content: '这是分享内容', time: '2020.12.17' },
      { username: '用户名称', userhead: '', content: '这是分享内容', time: '2020.12.17' },
      { username: '用户名称', userhead: '', content: '这是分享内容', time: '2020.12.17' }
    ],
    communityKind: [
      { text: '二手信息', bindtype: 'choose1' },
      { text: '经验分享', bindtype: 'choose2' },
      { text: '故障咨询', bindtype: 'choose3' },
      { text: '其他', bindtype: 'choose4' }
    ],
    hasUserInfo: null,
    searchcontent: '',
    choose1:null,
  ...
  tosearch: function () {
    ...
    this.search(searchcontent, searchkind)
  },
  choose1: function () {
  ...
  search: function (searchcontent, searchkind) {
    this.setData({
      comlist: [],
    })
    var that = this;
    ...
    wx.request({
      url: 'http://106.13.128.146:8080/GainCommunity',
      method: 'POST',
      header: {
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://106.13.128.146:8080/CommunityOnload',
      method: 'POST',
      header: {
        //'content-type': 'application/x-www-form-urlencoded' ,
        token: token
